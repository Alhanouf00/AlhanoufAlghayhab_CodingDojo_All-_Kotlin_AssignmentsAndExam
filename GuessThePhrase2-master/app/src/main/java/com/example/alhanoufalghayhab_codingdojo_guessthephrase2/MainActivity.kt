package com.example.alhanoufalghayhab_codingdojo_guessthephrase2
...
class MainActivity : AppCompatActivity() {
    ...
    //var saveData = getSharedPreferences("Score",Context.MODE_PRIVATE)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveData = getSharedPreferences("Score" , Context.MODE_PRIVATE)
    ...
    fun generatePhrase()
    {
        ...
        scoreText.text = "Your highest score is :" +  saveData.getInt("highScore",highScore).toString()
    ...
    fun checkPhrase( phraseGeusses: String)
    {
        ...
        else if(oldValue.contains(phraseGeusses))
        {
            ...
            custom.notifyDataSetChanged()
            saveScore.putInt("highScore",highScore)
            saveScore.apply()
